...
import { DoubleArrow, Memory, PauseCircleFilled, PlayCircleFilled, } from "@mui/icons-material";
...
const PrototypeCards = ({prototypes, isTheme})=>{
                    ...
                    >
                        ...
                        <CardContent>
                            <Typography sx={{ fontSize: isScrenSize?"12px" : "14px", 
                               ...
                               Here, we are showcasing some of our proptype model's pictures. How this model is 
                               evolving through out the entire project progress all the stages images are attached here.
                            </Typography>
                        </CardContent>
                    </Card>
                </Grid>
                        ...
                        <CardHeader
                            ...
                            avatar={
                                <Avatar className="card" sx={{
                                    ...
                                    <IconButton  sx={{color:"black"}}><Memory/></IconButton>
                                </Avatar>
                            }
                            title = {
                                <b className="icons" style={{
                                    ...
                                    fontWeight:"bold",
                                    fontSize: isScrenSize? "18px" : "30px"
                                }}>
                                    {prototypes[idx].name}
                                </b>
                            }
                    ...
                    <Card className="card" sx={{ minWidth: 275, marginTop:isScrenSize?"36px" : "175px", height:"auto",border:"3px solid skyblue",
                        ...
                        <CardContent>
                            <Typography sx={{ fontSize: isScrenSize?"12px" : "14px", 
                               ...
                               For more Images of our Prototype Model and System Design, feel free to click on the following button.
                            </Typography>
                        </CardContent>
                        <CardActions className="justify-content-center align-items-center d-flex">
                            {/* Navigate to the Page where our PPT is there */}
                            <a href="https://drive.google.com/file/d/1FoH3RSSYuJlTrGpCe0EKI4BVOhzG9wJ2/view?usp=drive_link">
